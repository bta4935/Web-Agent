...
// .wrangler/tmp/bundle-9meuYw/middleware-loader.entry.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// .wrangler/tmp/bundle-9meuYw/middleware-insertion-facade.js
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
...
var JSHandle = class {
  ...
  constructor(context2, remoteObject) {
    ...
    __classPrivateFieldSet(this, _JSHandle_context, context2, "f");
   ...
   */
  async getProperties() {
    assert3(__classPrivateFieldGet(this, _JSHandle_remoteObject, "f").objectId);
...
function createDeferredPromiseWithTimer(timeoutMessage, timeout = 5e3) {
  ...
  let resolver = /* @__PURE__ */ __name((_) => {
  }, "resolver");
  let rejector = /* @__PURE__ */ __name((_) => {
  }, "rejector");
...
__name(createDeferredPromiseWithTimer, "createDeferredPromiseWithTimer");
...
__name(createDebuggableDeferredPromise, "createDebuggableDeferredPromise");
...
function mitt(all) {
  ...
  return {
     ...
     * @memberOf mitt
     */
    on: /* @__PURE__ */ __name(function(type, handler) {
     ...
     * @memberOf mitt
     */
    off: /* @__PURE__ */ __name(function(type, handler) {
      var handlers = all.get(type);
      if (handlers) {
     ...
     * @memberOf mitt
     */
    emit: /* @__PURE__ */ __name(function(type, evt) {
...
_ExecutionContext_instances = /* @__PURE__ */ new WeakSet(), _ExecutionContext_evaluate = /* @__PURE__ */ __name(async function _ExecutionContext_evaluate2(returnByValue, pageFunction, ...args) {
...
var rewriteError = /* @__PURE__ */ __name((error3) => {
...
var HTTPRequest = class {
  ...
  continueRequestOverrides() {
    assert3(__classPrivateFieldGet3(this, _HTTPRequest_allowInterception, "f"), "Request Interception is not enabled!");
  ...
  async continue(overrides = {}, priority) {
    ...
    assert3(__classPrivateFieldGet3(this, _HTTPRequest_allowInterception, "f"), "Request Interception is not enabled!");
    assert3(!__classPrivateFieldGet3(this, _HTTPRequest_interceptionHandled, "f"), "Request is already handled!");
    if (priority === void 0) {
...
}, "_HTTPRequest_continue"), _HTTPRequest_respond = /* @__PURE__ */ __name(async function _HTTPRequest_respond2(response) {
  __classPrivateFieldSet2(this, _HTTPRequest_interceptionHandled, true, "f");
...
}, "_HTTPRequest_respond"), _HTTPRequest_abort = /* @__PURE__ */ __name(async function _HTTPRequest_abort2(errorReason) {
  __classPrivateFieldSet2(this, _HTTPRequest_interceptionHandled, true, "f");
  if (this._interceptionId === void 0) {
...
var HTTPResponse = class {
  ...
  buffer() {
    if (!__classPrivateFieldGet5(this, _HTTPResponse_contentPromise, "f")) {
      __classPrivateFieldSet4(this, _HTTPResponse_contentPromise, __classPrivateFieldGet5(this, _HTTPResponse_bodyLoadedPromise, "f").then(async (error3) => {
        if (error3) {
          throw error3;
        }
        try {
...
_HTTPResponse_client = /* @__PURE__ */ new WeakMap(), _HTTPResponse_request = /* @__PURE__ */ new WeakMap(), _HTTPResponse_contentPromise = /* @__PURE__ */ new WeakMap(), _HTTPResponse_bodyLoadedPromise = /* @__PURE__ */ new WeakMap(), _HTTPResponse_bodyLoadedPromiseFulfill = /* @__PURE__ */ new WeakMap(), _HTTPResponse_remoteAddress = /* @__PURE__ */ new WeakMap(), _HTTPResponse_status = /* @__PURE__ */ new WeakMap(), _HTTPResponse_statusText = /* @__PURE__ */ new WeakMap(), _HTTPResponse_url = /* @__PURE__ */ new WeakMap(), _HTTPResponse_fromDiskCache = /* @__PURE__ */ new WeakMap(), _HTTPResponse_fromServiceWorker = /* @__PURE__ */ new WeakMap(), _HTTPResponse_headers = /* @__PURE__ */ new WeakMap(), _HTTPResponse_securityDetails = /* @__PURE__ */ new WeakMap(), _HTTPResponse_timing = /* @__PURE__ */ new WeakMap(), _HTTPResponse_instances = /* @__PURE__ */ new WeakSet(), _HTTPResponse_parseStatusTextFromExtrInfo = /* @__PURE__ */ __name(function _HTTPResponse_parseStatusTextFromExtrInfo2(extraInfo) {
...
_NetworkManager_client = /* @__PURE__ */ new WeakMap(), _NetworkManager_ignoreHTTPSErrors = /* @__PURE__ */ new WeakMap(), _NetworkManager_frameManager = /* @__PURE__ */ new WeakMap(), _NetworkManager_networkEventManager = /* @__PURE__ */ new WeakMap(), _NetworkManager_extraHTTPHeaders = /* @__PURE__ */ new WeakMap(), _NetworkManager_credentials = /* @__PURE__ */ new WeakMap(), _NetworkManager_attemptedAuthentications = /* @__PURE__ */ new WeakMap(), _NetworkManager_userRequestInterceptionEnabled = /* @__PURE__ */ new WeakMap(), _NetworkManager_protocolRequestInterceptionEnabled = /* @__PURE__ */ new WeakMap(), _NetworkManager_userCacheDisabled = /* @__PURE__ */ new WeakMap(), _NetworkManager_emulatedNetworkConditions = /* @__PURE__ */ new WeakMap(), _NetworkManager_deferredInitPromise = /* @__PURE__ */ new WeakMap(), _NetworkManager_instances = /* @__PURE__ */ new WeakSet(), _NetworkManager_updateNetworkConditions = /* @__PURE__ */ __name(async function _NetworkManager_updateNetworkConditions2() {
...
}, "_NetworkManager_updateNetworkConditions"), _NetworkManager_updateProtocolRequestInterception = /* @__PURE__ */ __name(async function _NetworkManager_updateProtocolRequestInterception2() {
...
}, "_NetworkManager_updateProtocolRequestInterception"), _NetworkManager_cacheDisabled = /* @__PURE__ */ __name(function _NetworkManager_cacheDisabled2() {
  return __classPrivateFieldGet7(this, _NetworkManager_userCacheDisabled, "f");
}, "_NetworkManager_cacheDisabled"), _NetworkManager_updateProtocolCacheDisabled = /* @__PURE__ */ __name(async function _NetworkManager_updateProtocolCacheDisabled2() {
...
}, "_NetworkManager_updateProtocolCacheDisabled"), _NetworkManager_onRequestWillBeSent = /* @__PURE__ */ __name(function _NetworkManager_onRequestWillBeSent2(event) {
...
}, "_NetworkManager_onRequestWillBeSent"), _NetworkManager_onAuthRequired = /* @__PURE__ */ __name(function _NetworkManager_onAuthRequired2(event) {
...
}, "_NetworkManager_onAuthRequired"), _NetworkManager_onRequestPaused = /* @__PURE__ */ __name(function _NetworkManager_onRequestPaused2(event) {
...
}, "_NetworkManager_onRequestPaused"), _NetworkManager_patchRequestEventHeaders = /* @__PURE__ */ __name(function _NetworkManager_patchRequestEventHeaders2(requestWillBeSentEvent, requestPausedEvent) {
  requestWillBeSentEvent.request.headers = {
    ...requestWillBeSentEvent.request.headers,
    // includes extra headers, like: Accept, Origin
    ...requestPausedEvent.request.headers
  };
}, "_NetworkManager_patchRequestEventHeaders"), _NetworkManager_onRequest = /* @__PURE__ */ __name(function _NetworkManager_onRequest2(event, fetchRequestId) {
  let redirectChain = [];
...
}, "_NetworkManager_onRequest"), _NetworkManager_onRequestServedFromCache = /* @__PURE__ */ __name(function _NetworkManager_onRequestServedFromCache2(event) {
...
}, "_NetworkManager_onRequestServedFromCache"), _NetworkManager_handleRequestRedirect = /* @__PURE__ */ __name(function _NetworkManager_handleRequestRedirect2(request, responsePayload, extraInfo) {
...
}, "_NetworkManager_handleRequestRedirect"), _NetworkManager_emitResponseEvent = /* @__PURE__ */ __name(function _NetworkManager_emitResponseEvent2(responseReceived, extraInfo) {
  ...
  request._response = response;
  this.emit(NetworkManagerEmittedEvents.Response, response);
}, "_NetworkManager_emitResponseEvent"), _NetworkManager_onResponseReceived = /* @__PURE__ */ __name(function _NetworkManager_onResponseReceived2(event) {
  const request = __classPrivateFieldGet7(this, _NetworkManager_networkEventManager, "f").getRequest(event.requestId);
  let extraInfo = null;
...
}, "_NetworkManager_onResponseReceived"), _NetworkManager_onResponseReceivedExtraInfo = /* @__PURE__ */ __name(function _NetworkManager_onResponseReceivedExtraInfo2(event) {
  ...
  __classPrivateFieldGet7(this, _NetworkManager_networkEventManager, "f").responseExtraInfo(event.requestId).push(event);
}, "_NetworkManager_onResponseReceivedExtraInfo"), _NetworkManager_forgetRequest = /* @__PURE__ */ __name(function _NetworkManager_forgetRequest2(request, events) {
...
}, "_NetworkManager_forgetRequest"), _NetworkManager_onLoadingFinished = /* @__PURE__ */ __name(function _NetworkManager_onLoadingFinished2(event) {
  const queuedEvents = __classPrivateFieldGet7(this, _NetworkManager_networkEventManager, "f").getQueuedEventGroup(event.requestId);
  if (queuedEvents) {
...
}, "_NetworkManager_onLoadingFinished"), _NetworkManager_emitLoadingFinished = /* @__PURE__ */ __name(function _NetworkManager_emitLoadingFinished2(event) {
  var _a2;
  const request = __classPrivateFieldGet7(this, _NetworkManager_networkEventManager, "f").getRequest(event.requestId);
  if (!request) {
    return;
  ...
  this.emit(NetworkManagerEmittedEvents.RequestFinished, request);
}, "_NetworkManager_emitLoadingFinished"), _NetworkManager_onLoadingFailed = /* @__PURE__ */ __name(function _NetworkManager_onLoadingFailed2(event) {
  const queuedEvents = __classPrivateFieldGet7(this, _NetworkManager_networkEventManager, "f").getQueuedEventGroup(event.requestId);
  if (queuedEvents) {
...
}, "_NetworkManager_onLoadingFailed"), _NetworkManager_emitLoadingFailed = /* @__PURE__ */ __name(function _NetworkManager_emitLoadingFailed2(event) {
  const request = __classPrivateFieldGet7(this, _NetworkManager_networkEventManager, "f").getRequest(event.requestId);
  if (!request) {
    return;
  }
...
var FrameManager = class extends EventEmitter2 {
  ...
  async initialize(targetId, client = __classPrivateFieldGet8(this, _FrameManager_client, "f")) {
    ...
    try {
      ...
      if (isErrorLike(error3) && (error3.message.includes("Target closed") || error3.message.includes("Session closed"))) {
        return;
      }
      throw error3;
    } finally {
  ...
  executionContextById(contextId, session = __classPrivateFieldGet8(this, _FrameManager_client, "f")) {
    ...
    const context2 = __classPrivateFieldGet8(this, _FrameManager_contextIdToContext, "f").get(key);
  ...
  mainFrame() {
    assert3(__classPrivateFieldGet8(this, _FrameManager_mainFrame, "f"), "Requesting main frame too early!");
...
_FrameManager_page = /* @__PURE__ */ new WeakMap(), _FrameManager_networkManager = /* @__PURE__ */ new WeakMap(), _FrameManager_timeoutSettings = /* @__PURE__ */ new WeakMap(), _FrameManager_frames = /* @__PURE__ */ new WeakMap(), _FrameManager_contextIdToContext = /* @__PURE__ */ new WeakMap(), _FrameManager_isolatedWorlds = /* @__PURE__ */ new WeakMap(), _FrameManager_mainFrame = /* @__PURE__ */ new WeakMap(), _FrameManager_client = /* @__PURE__ */ new WeakMap(), _FrameManager_framesPendingTargetInit = /* @__PURE__ */ new WeakMap(), _FrameManager_framesPendingAttachment = /* @__PURE__ */ new WeakMap(), _FrameManager_instances = /* @__PURE__ */ new WeakSet(), _FrameManager_onLifecycleEvent = /* @__PURE__ */ __name(function _FrameManager_onLifecycleEvent2(event) {
...
}, "_FrameManager_onLifecycleEvent"), _FrameManager_onFrameStartedLoading = /* @__PURE__ */ __name(function _FrameManager_onFrameStartedLoading2(frameId) {
  const frame = __classPrivateFieldGet8(this, _FrameManager_frames, "f").get(frameId);
  if (!frame) {
    return;
  }
  frame._onLoadingStarted();
}, "_FrameManager_onFrameStartedLoading"), _FrameManager_onFrameStoppedLoading = /* @__PURE__ */ __name(function _FrameManager_onFrameStoppedLoading2(frameId) {
  const frame = __classPrivateFieldGet8(this, _FrameManager_frames, "f").get(frameId);
  if (!frame) {
    return;
  }
  ...
  this.emit(FrameManagerEmittedEvents.LifecycleEvent, frame);
}, "_FrameManager_onFrameStoppedLoading"), _FrameManager_handleFrameTree = /* @__PURE__ */ __name(function _FrameManager_handleFrameTree2(session, frameTree) {
...
}, "_FrameManager_handleFrameTree"), _FrameManager_onFrameAttached = /* @__PURE__ */ __name(function _FrameManager_onFrameAttached2(session, frameId, parentFrameId) {
  ...
  const complete = /* @__PURE__ */ __name((parentFrame2) => {
    assert3(parentFrame2, `Parent frame ${parentFrameId} not found`);
...
}, "_FrameManager_onFrameAttached"), _FrameManager_onFrameNavigated = /* @__PURE__ */ __name(function _FrameManager_onFrameNavigated2(framePayload) {
  ...
  const complete = /* @__PURE__ */ __name((frame2) => {
    assert3(isMainFrame || frame2, `Missing frame isMainFrame=${isMainFrame}, frameId=${frameId}`);
    if (frame2) {
...
}, "_FrameManager_onFrameNavigated"), _FrameManager_createIsolatedWorld = /* @__PURE__ */ __name(async function _FrameManager_createIsolatedWorld2(session, name) {
...
}, "_FrameManager_createIsolatedWorld"), _FrameManager_onFrameNavigatedWithinDocument = /* @__PURE__ */ __name(function _FrameManager_onFrameNavigatedWithinDocument2(frameId, url) {
  const frame = __classPrivateFieldGet8(this, _FrameManager_frames, "f").get(frameId);
  if (!frame) {
    return;
  }
...
}, "_FrameManager_onFrameNavigatedWithinDocument"), _FrameManager_onFrameDetached = /* @__PURE__ */ __name(function _FrameManager_onFrameDetached2(frameId, reason) {
  const frame = __classPrivateFieldGet8(this, _FrameManager_frames, "f").get(frameId);
  if (reason === "remove") {
    if (frame) {
      __classPrivateFieldGet8(this, _FrameManager_instances, "m", _FrameManager_removeFramesRecursively).call(this, frame);
...
}, "_FrameManager_onFrameDetached"), _FrameManager_onExecutionContextCreated = /* @__PURE__ */ __name(function _FrameManager_onExecutionContextCreated2(contextPayload, session) {
  ...
  const context2 = new ExecutionContext((frame === null || frame === void 0 ? void 0 : frame._client()) || __classPrivateFieldGet8(this, _FrameManager_client, "f"), contextPayload, world);
  if (world) {
    world.setContext(context2);
  }
  const key = `${session.id()}:${contextPayload.id}`;
  __classPrivateFieldGet8(this, _FrameManager_contextIdToContext, "f").set(key, context2);
}, "_FrameManager_onExecutionContextCreated"), _FrameManager_onExecutionContextDestroyed = /* @__PURE__ */ __name(function _FrameManager_onExecutionContextDestroyed2(executionContextId, session) {
...
}, "_FrameManager_onExecutionContextDestroyed"), _FrameManager_onExecutionContextsCleared = /* @__PURE__ */ __name(function _FrameManager_onExecutionContextsCleared2(session) {
  for (const [key, context2] of __classPrivateFieldGet8(this, _FrameManager_contextIdToContext, "f").entries()) {
...
}, "_FrameManager_onExecutionContextsCleared"), _FrameManager_removeFramesRecursively = /* @__PURE__ */ __name(function _FrameManager_removeFramesRecursively2(frame) {
...
function createProtocolError(error3, method, object) {
  ...
  return rewriteError2(error3, message, object.error.message);
}
__name(createProtocolError, "createProtocolError");
function rewriteError2(error3, message, originalMessage) {
...
var LifecycleWatcher = class {
  ...
  constructor(frameManager, frame, waitUntil, timeout) {
    ...
    _LifecycleWatcher_sameDocumentNavigationCompleteCallback.set(this, noop2);
    ...
    _LifecycleWatcher_lifecycleCallback.set(this, noop2);
    ...
    _LifecycleWatcher_newDocumentNavigationCompleteCallback.set(this, noop2);
    ...
    _LifecycleWatcher_terminationCallback.set(this, noop2);
...
_LifecycleWatcher_expectedLifecycle = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_frameManager = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_frame = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_timeout = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_navigationRequest = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_eventListeners = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_initialLoaderId = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_sameDocumentNavigationCompleteCallback = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_sameDocumentNavigationPromise = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_lifecycleCallback = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_lifecyclePromise = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_newDocumentNavigationCompleteCallback = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_newDocumentNavigationPromise = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_terminationCallback = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_terminationPromise = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_timeoutPromise = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_maximumTimer = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_hasSameDocumentNavigation = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_swapped = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_navigationResponseReceived = /* @__PURE__ */ new WeakMap(), _LifecycleWatcher_instances = /* @__PURE__ */ new WeakSet(), _LifecycleWatcher_onRequest = /* @__PURE__ */ __name(function _LifecycleWatcher_onRequest2(request) {
...
}, "_LifecycleWatcher_onRequest"), _LifecycleWatcher_onResponse = /* @__PURE__ */ __name(function _LifecycleWatcher_onResponse2(response) {
  var _a2, _b;
  ...
  (_b = __classPrivateFieldGet10(this, _LifecycleWatcher_navigationResponseReceived, "f")) === null || _b === void 0 ? void 0 : _b.resolve();
}, "_LifecycleWatcher_onResponse"), _LifecycleWatcher_onFrameDetached = /* @__PURE__ */ __name(function _LifecycleWatcher_onFrameDetached2(frame) {
  ...
  __classPrivateFieldGet10(this, _LifecycleWatcher_instances, "m", _LifecycleWatcher_checkLifecycleComplete).call(this);
}, "_LifecycleWatcher_onFrameDetached"), _LifecycleWatcher_terminate = /* @__PURE__ */ __name(function _LifecycleWatcher_terminate2(error3) {
  __classPrivateFieldGet10(this, _LifecycleWatcher_terminationCallback, "f").call(null, error3);
}, "_LifecycleWatcher_terminate"), _LifecycleWatcher_createTimeoutPromise = /* @__PURE__ */ __name(async function _LifecycleWatcher_createTimeoutPromise2() {
...
}, "_LifecycleWatcher_createTimeoutPromise"), _LifecycleWatcher_navigatedWithinDocument = /* @__PURE__ */ __name(function _LifecycleWatcher_navigatedWithinDocument2(frame) {
  ...
  __classPrivateFieldGet10(this, _LifecycleWatcher_instances, "m", _LifecycleWatcher_checkLifecycleComplete).call(this);
}, "_LifecycleWatcher_navigatedWithinDocument"), _LifecycleWatcher_navigated = /* @__PURE__ */ __name(function _LifecycleWatcher_navigated2(frame) {
  if (frame !== __classPrivateFieldGet10(this, _LifecycleWatcher_frame, "f")) {
    return;
  }
  __classPrivateFieldGet10(this, _LifecycleWatcher_instances, "m", _LifecycleWatcher_checkLifecycleComplete).call(this);
}, "_LifecycleWatcher_navigated"), _LifecycleWatcher_frameSwapped = /* @__PURE__ */ __name(function _LifecycleWatcher_frameSwapped2(frame) {
  if (frame !== __classPrivateFieldGet10(this, _LifecycleWatcher_frame, "f")) {
    return;
  }
  __classPrivateFieldSet8(this, _LifecycleWatcher_swapped, true, "f");
  __classPrivateFieldGet10(this, _LifecycleWatcher_instances, "m", _LifecycleWatcher_checkLifecycleComplete).call(this);
}, "_LifecycleWatcher_frameSwapped"), _LifecycleWatcher_checkLifecycleComplete = /* @__PURE__ */ __name(function _LifecycleWatcher_checkLifecycleComplete2() {
...
var IsolatedWorld = class _IsolatedWorld {
  static {
  ...
  constructor(frame) {
    ...
    _IsolatedWorld_onBindingCalled.set(this, async (event) => {
      ...
      if (type !== "internal" || !__classPrivateFieldGet11(this, _IsolatedWorld_ctxBindings, "f").has(__classPrivateFieldGet11(_IsolatedWorld, _a, "f", _IsolatedWorld_bindingIdentifier).call(_IsolatedWorld, name, context2._contextId))) {
        return;
      }
      if (context2._contextId !== event.executionContextId) {
        return;
      }
      try {
        ...
        await context2.evaluate(deliverResult, name, seq, result);
      } catch (error3) {
  ...
  setContext(context2) {
    assert3(__classPrivateFieldGet11(this, _IsolatedWorld_contextPromise, "f"), `ExecutionContext ${context2._contextId} has already been set.`);
    __classPrivateFieldGet11(this, _IsolatedWorld_ctxBindings, "f").clear();
    __classPrivateFieldGet11(this, _IsolatedWorld_contextPromise, "f").resolve(context2);
  ...
  async document() {
    ...
    const context2 = await this.executionContext();
    __classPrivateFieldSet9(this, _IsolatedWorld_document, await context2.evaluateHandle(() => {
      return document;
    }), "f");
    return __classPrivateFieldGet11(this, _IsolatedWorld_document, "f");
  }
  ...
  async addScriptTag(options) {
    ...
    if (url !== null) {
      try {
        const context2 = await this.executionContext();
        return await context2.evaluateHandle(addScriptUrl, url, id, type);
      } catch (error3) {
    ...
    if (path !== null) {
      let fs;
      try {
        fs = (await Promise.resolve().then(() => (init_fs2(), fs_exports))).promises;
      } catch (error3) {
      ...
      const context2 = await this.executionContext();
      return await context2.evaluateHandle(addScriptContent, contents, id, type);
    }
    if (content !== null) {
      const context2 = await this.executionContext();
      return await context2.evaluateHandle(addScriptContent, content, id, type);
    }
  ...
  async addStyleTag(options) {
    ...
    if (url !== null) {
      try {
        const context2 = await this.executionContext();
        return await context2.evaluateHandle(addStyleUrl, url);
      } catch (error3) {
    ...
    if (content !== null) {
      const context2 = await this.executionContext();
      return await context2.evaluateHandle(addStyleContent, content);
    }
    throw new Error("Provide an object with a `url`, `path` or `content` property");
  ...
  async _addBindingToContext(context2, name) {
    if (__classPrivateFieldGet11(this, _IsolatedWorld_ctxBindings, "f").has(__classPrivateFieldGet11(_IsolatedWorld, _a, "f", _IsolatedWorld_bindingIdentifier).call(_IsolatedWorld, name, context2._contextId))) {
      return;
    }
    if (__classPrivateFieldGet11(this, _IsolatedWorld_settingUpBinding, "f")) {
      ...
      return this._addBindingToContext(context2, name);
    }
    const bind = /* @__PURE__ */ __name(async (name2) => {
      const expression = pageBindingInitString("internal", name2);
      try {
        await context2._client.send("Runtime.addBinding", {
          name: name2,
          // eslint-disable-next-line @typescript-eslint/ban-ts-comment
          // @ts-ignore The protocol definition is not up to date.
          executionContextName: context2._contextName
        });
        await context2.evaluate(expression);
      } catch (error3) {
      ...
      __classPrivateFieldGet11(this, _IsolatedWorld_ctxBindings, "f").add(__classPrivateFieldGet11(_IsolatedWorld, _a, "f", _IsolatedWorld_bindingIdentifier).call(_IsolatedWorld, name2, context2._contextId));
    }, "bind");
  ...
  async _waitForSelectorInPage(queryOne2, root, selector, options, binding2) {
    ...
    const title2 = `selector \`${selector}\`${waitForHidden ? " to be hidden" : ""}`;
  ...
  async adoptHandle(handle) {
    const executionContext = await this.executionContext();
    assert3(handle.executionContext() !== executionContext, "Cannot adopt handle that already belongs to this execution context");
...
var WaitTask = class {
  ...
  constructor(options) {
    ...
    _WaitTask_resolve.set(this, noop3);
    _WaitTask_reject.set(this, noop3);
    ...
    if (isString(options.polling)) {
      assert3(options.polling === "raf" || options.polling === "mutation", "Unknown polling option: " + options.polling);
    } else if (isNumber(options.polling)) {
      assert3(options.polling > 0, "Cannot poll with non-positive interval: " + options.polling);
    } else {
  ...
  terminate(error3) {
    ...
    __classPrivateFieldGet11(this, _WaitTask_reject, "f").call(this, error3);
  ...
  async rerun() {
    ...
    if (!error3 && await __classPrivateFieldGet11(this, _WaitTask_isolatedWorld, "f").evaluate((s) => {
      return !s;
    }, success).catch(() => {
      return true;
    })) {
...
async function waitForPredicatePageFunction(root, predicateBody, predicateAcceptsContextElement, polling, timeout, ...args) {
  ...
  __name(pollMutation, "pollMutation");
  ...
  __name(pollInterval, "pollInterval");
}
...
var Frame = class {
  ...
  async waitForSelector(selector, options = {}) {
    ...
    assert3(queryHandler.waitFor, "Query handler does not support waiting");
...
__name(queryAXTree, "queryAXTree");
...
__name(isKnownAttribute, "isKnownAttribute");
...
__name(parseAriaSelector, "parseAriaSelector");
var queryOneId = /* @__PURE__ */ __name(async (element, selector) => {
...
var queryOne = /* @__PURE__ */ __name(async (element, selector) => {
...
var waitFor = /* @__PURE__ */ __name(async (elementOrFrame, selector, options) => {
  let frame;
  let element;
  ...
  const binding2 = {
    ...
    pptrFunction: /* @__PURE__ */ __name(async (selector2) => {
  ...
  }, element, selector, options, binding2);
  if (element) {
...
var queryAll = /* @__PURE__ */ __name(async (element, selector) => {
...
__name(internalizeCustomQueryHandler, "internalizeCustomQueryHandler");
var defaultHandler = internalizeCustomQueryHandler({
  queryOne: /* @__PURE__ */ __name((element, selector) => {
    if (!("querySelector" in element)) {
      throw new Error(`Could not invoke \`querySelector\` on node of type ${element.nodeName}.`);
    }
    return element.querySelector(selector);
  }, "queryOne"),
  queryAll: /* @__PURE__ */ __name((element, selector) => {
...
var pierceHandler = internalizeCustomQueryHandler({
  queryOne: /* @__PURE__ */ __name((element, selector) => {
    let found = null;
    const search = /* @__PURE__ */ __name((root) => {
  ...
  queryAll: /* @__PURE__ */ __name((element, selector) => {
    const result = [];
    const collect = /* @__PURE__ */ __name((root) => {
      const iter = document.createTreeWalker(root, NodeFilter.SHOW_ELEMENT);
      do {
        const currentNode = iter.currentNode;
        if (currentNode.shadowRoot) {
...
__name(registerCustomQueryHandler, "registerCustomQueryHandler");
function unregisterCustomQueryHandler(name) {
  QUERY_HANDLERS.delete(name);
}
__name(unregisterCustomQueryHandler, "unregisterCustomQueryHandler");
function customQueryHandlerNames() {
  return [...QUERY_HANDLERS.keys()];
}
__name(customQueryHandlerNames, "customQueryHandlerNames");
function clearCustomQueryHandlers() {
  QUERY_HANDLERS.clear();
}
__name(clearCustomQueryHandlers, "clearCustomQueryHandlers");
...
var ElementHandle = class extends JSHandle {
  ...
  async $(selector) {
    const { updatedSelector, queryHandler } = getQueryHandlerAndSelector(selector);
    assert3(queryHandler.queryOne, "Cannot handle queries for a single element with the given selector");
  ...
  async $$(selector) {
    const { updatedSelector, queryHandler } = getQueryHandlerAndSelector(selector);
    assert3(queryHandler.queryAll, "Cannot handle queries for a multiple element with the given selector");
   ...
   */
  async drag(target) {
    assert3(__classPrivateFieldGet13(this, _ElementHandle_instances, "a", _ElementHandle_page_get).isDragInterceptionEnabled(), "Drag Interception is not enabled!");
    await __classPrivateFieldGet13(this, _ElementHandle_instances, "m", _ElementHandle_scrollIntoViewIfNeeded).call(this);
...
_ElementHandle_frame = /* @__PURE__ */ new WeakMap(), _ElementHandle_instances = /* @__PURE__ */ new WeakSet(), _ElementHandle_frameManager_get = /* @__PURE__ */ __name(function _ElementHandle_frameManager_get2() {
  return __classPrivateFieldGet13(this, _ElementHandle_frame, "f")._frameManager;
}, "_ElementHandle_frameManager_get"), _ElementHandle_page_get = /* @__PURE__ */ __name(function _ElementHandle_page_get2() {
  return __classPrivateFieldGet13(this, _ElementHandle_frame, "f").page();
}, "_ElementHandle_page_get"), _ElementHandle_scrollIntoViewIfNeeded = /* @__PURE__ */ __name(async function _ElementHandle_scrollIntoViewIfNeeded2() {
  ...
  try {
    ...
    await this.evaluate(async (element, pageJavascriptEnabled) => {
      const visibleRatio = /* @__PURE__ */ __name(async () => {
...
}, "_ElementHandle_scrollIntoViewIfNeeded"), _ElementHandle_getOOPIFOffsets = /* @__PURE__ */ __name(async function _ElementHandle_getOOPIFOffsets2(frame) {
  let offsetX = 0;
  let offsetY = 0;
...
}, "_ElementHandle_getOOPIFOffsets"), _ElementHandle_getBoxModel = /* @__PURE__ */ __name(function _ElementHandle_getBoxModel2() {
  const params = {
    objectId: this.remoteObject().objectId
  };
...
}, "_ElementHandle_getBoxModel"), _ElementHandle_fromProtocolQuad = /* @__PURE__ */ __name(function _ElementHandle_fromProtocolQuad2(quad) {
  return [
    { x: quad[0], y: quad[1] },
    { x: quad[2], y: quad[3] },
    { x: quad[4], y: quad[5] },
...
}, "_ElementHandle_fromProtocolQuad"), _ElementHandle_intersectQuadWithViewport = /* @__PURE__ */ __name(function _ElementHandle_intersectQuadWithViewport2(quad, width, height) {
...
function createJSHandle(context2, remoteObject) {
  if (remoteObject.subtype === "node" && context2._world) {
    return new ElementHandle(context2, remoteObject, context2._world.frame());
  }
  return new JSHandle(context2, remoteObject);
}
...
function pageBindingInitString(type, name) {
  function addPageBinding(type2, bindingName) {
    const win = window;
    const binding2 = win[bindingName];
    win[bindingName] = (...args) => {
      ...
      binding2(JSON.stringify({ type: type2, name: bindingName, seq, args }));
      return promise;
    };
  }
...
function pageBindingDeliverErrorString(name, seq, message, stack) {
  function deliverError(name2, seq2, message2, stack2) {
    ...
    error3.stack = stack2;
    window[name2].callbacks.get(seq2).reject(error3);
    window[name2].callbacks.delete(seq2);
  }
...
function makePredicateString(predicate, predicateQueryHandler2) {
  function checkWaitForOptions2(node, waitForVisible, waitForHidden) {
    ...
    __name(hasVisibleBoundingBox, "hasVisibleBoundingBox");
  }
  __name(checkWaitForOptions2, "checkWaitForOptions");
  return `
    (() => {
...
__name(makePredicateString, "makePredicateString");
...
_AXNode_richlyEditable = /* @__PURE__ */ new WeakMap(), _AXNode_editable = /* @__PURE__ */ new WeakMap(), _AXNode_focusable = /* @__PURE__ */ new WeakMap(), _AXNode_hidden = /* @__PURE__ */ new WeakMap(), _AXNode_name = /* @__PURE__ */ new WeakMap(), _AXNode_role = /* @__PURE__ */ new WeakMap(), _AXNode_ignored = /* @__PURE__ */ new WeakMap(), _AXNode_cachedHasFocusableChild = /* @__PURE__ */ new WeakMap(), _AXNode_instances = /* @__PURE__ */ new WeakSet(), _AXNode_isPlainTextField = /* @__PURE__ */ __name(function _AXNode_isPlainTextField2() {
...
}, "_AXNode_isPlainTextField"), _AXNode_isTextOnlyObject = /* @__PURE__ */ __name(function _AXNode_isTextOnlyObject2() {
  const role = __classPrivateFieldGet14(this, _AXNode_role, "f");
  return role === "LineBreak" || role === "text" || role === "InlineTextBox";
}, "_AXNode_isTextOnlyObject"), _AXNode_hasFocusableChild = /* @__PURE__ */ __name(function _AXNode_hasFocusableChild2() {
...
var JSCoverage = class {
  ...
  async start(options = {}) {
    assert3(!__classPrivateFieldGet16(this, _JSCoverage_enabled, "f"), "JSCoverage is already enabled");
  ...
  async stop() {
    assert3(__classPrivateFieldGet16(this, _JSCoverage_enabled, "f"), "JSCoverage is not enabled");
...
var CSSCoverage = class {
  ...
  async start(options = {}) {
    assert3(!__classPrivateFieldGet16(this, _CSSCoverage_enabled, "f"), "CSSCoverage is already enabled");
  ...
  async stop() {
    assert3(__classPrivateFieldGet16(this, _CSSCoverage_enabled, "f"), "CSSCoverage is not enabled");
...
var Dialog = class {
  ...
  async accept(promptText) {
    assert3(!__classPrivateFieldGet17(this, _Dialog_handled, "f"), "Cannot accept dialog which is already handled!");
   ...
   */
  async dismiss() {
    assert3(!__classPrivateFieldGet17(this, _Dialog_handled, "f"), "Cannot dismiss dialog which is already handled!");
    __classPrivateFieldSet15(this, _Dialog_handled, true, "f");
    await __classPrivateFieldGet17(this, _Dialog_client, "f").send("Page.handleJavaScriptDialog", {
      accept: false
    });
...
var FileChooser = class {
  ...
  async accept(filePaths) {
    assert3(!__classPrivateFieldGet19(this, _FileChooser_handled, "f"), "Cannot accept FileChooser which is already handled!");
   ...
   */
  cancel() {
    assert3(!__classPrivateFieldGet19(this, _FileChooser_handled, "f"), "Cannot cancel FileChooser which is already handled!");
    __classPrivateFieldSet17(this, _FileChooser_handled, true, "f");
  }
};
...
_Keyboard_client = /* @__PURE__ */ new WeakMap(), _Keyboard_pressedKeys = /* @__PURE__ */ new WeakMap(), _Keyboard_instances = /* @__PURE__ */ new WeakSet(), _Keyboard_modifierBit = /* @__PURE__ */ __name(function _Keyboard_modifierBit2(key) {
  if (key === "Alt") {
    return 1;
  }
  if (key === "Control") {
  ...
  return 0;
}, "_Keyboard_modifierBit"), _Keyboard_keyDescriptionForString = /* @__PURE__ */ __name(function _Keyboard_keyDescriptionForString2(keyString) {
...
var WebWorker = class extends EventEmitter2 {
  ...
  constructor(client, url, consoleAPICalled, exceptionThrown) {
    ...
    __classPrivateFieldGet22(this, _WebWorker_client, "f").once("Runtime.executionContextCreated", async (event) => {
      ...
      __classPrivateFieldGet22(this, _WebWorker_executionContext, "f").resolve(context2);
    });
    __classPrivateFieldGet22(this, _WebWorker_client, "f").on("Runtime.consoleAPICalled", async (event) => {
      const context2 = await __classPrivateFieldGet22(this, _WebWorker_executionContext, "f");
      return consoleAPICalled(event.type, event.args.map((object) => {
        return new JSHandle(context2, object);
      }), event.stackTrace);
    });
...
var Page = class _Page extends EventEmitter2 {
  static {
    __name(this, "Page");
  }
  /**
  ...
  static async _create(client, target, ignoreHTTPSErrors, defaultViewport, screenshotTaskQueue) {
    const page = new _Page(client, target, ignoreHTTPSErrors, screenshotTaskQueue);
  ...
  async queryObjects(prototypeHandle) {
    ...
    assert3(remoteObject.objectId, "Prototype JSHandle must not be referencing primitive value");
  ...
  async emulateMediaType(type) {
    assert3(type === "screen" || type === "print" || (type !== null && type !== void 0 ? type : void 0) === void 0, "Unsupported media type: " + type);
...
_Page_closed = /* @__PURE__ */ new WeakMap(), _Page_client = /* @__PURE__ */ new WeakMap(), _Page_target = /* @__PURE__ */ new WeakMap(), _Page_keyboard = /* @__PURE__ */ new WeakMap(), _Page_mouse = /* @__PURE__ */ new WeakMap(), _Page_timeoutSettings = /* @__PURE__ */ new WeakMap(), _Page_touchscreen = /* @__PURE__ */ new WeakMap(), _Page_accessibility = /* @__PURE__ */ new WeakMap(), _Page_frameManager = /* @__PURE__ */ new WeakMap(), _Page_emulationManager = /* @__PURE__ */ new WeakMap(), _Page_pageBindings = /* @__PURE__ */ new WeakMap(), _Page_coverage = /* @__PURE__ */ new WeakMap(), _Page_javascriptEnabled = /* @__PURE__ */ new WeakMap(), _Page_viewport = /* @__PURE__ */ new WeakMap(), _Page_screenshotTaskQueue = /* @__PURE__ */ new WeakMap(), _Page_workers = /* @__PURE__ */ new WeakMap(), _Page_fileChooserPromises = /* @__PURE__ */ new WeakMap(), _Page_disconnectPromise = /* @__PURE__ */ new WeakMap(), _Page_userDragInterceptionEnabled = /* @__PURE__ */ new WeakMap(), _Page_handlerMap = /* @__PURE__ */ new WeakMap(), _Page_onDetachedFromTarget = /* @__PURE__ */ new WeakMap(), _Page_onAttachedToTarget = /* @__PURE__ */ new WeakMap(), _Page_instances = /* @__PURE__ */ new WeakSet(), _Page_initialize = /* @__PURE__ */ __name(async function _Page_initialize2() {
...
}, "_Page_initialize"), _Page_onFileChooser = /* @__PURE__ */ __name(async function _Page_onFileChooser2(event) {
  if (!__classPrivateFieldGet23(this, _Page_fileChooserPromises, "f").size) {
    return;
  }
...
}, "_Page_onFileChooser"), _Page_onTargetCrashed = /* @__PURE__ */ __name(function _Page_onTargetCrashed2() {
  this.emit("error", new Error("Page crashed!"));
}, "_Page_onTargetCrashed"), _Page_onLogEntryAdded = /* @__PURE__ */ __name(function _Page_onLogEntryAdded2(event) {
...
}, "_Page_onLogEntryAdded"), _Page_emitMetrics = /* @__PURE__ */ __name(function _Page_emitMetrics2(event) {
  this.emit("metrics", {
    title: event.title,
    metrics: __classPrivateFieldGet23(this, _Page_instances, "m", _Page_buildMetricsObject).call(this, event.metrics)
  });
}, "_Page_emitMetrics"), _Page_buildMetricsObject = /* @__PURE__ */ __name(function _Page_buildMetricsObject2(metrics) {
  const result = {};
  ...
  return result;
}, "_Page_buildMetricsObject"), _Page_handleException = /* @__PURE__ */ __name(function _Page_handleException2(exceptionDetails) {
  const message = getExceptionMessage(exceptionDetails);
  const err = new Error(message);
  err.stack = "";
  this.emit("pageerror", err);
}, "_Page_handleException"), _Page_onConsoleAPI = /* @__PURE__ */ __name(async function _Page_onConsoleAPI2(event) {
  if (event.executionContextId === 0) {
    return;
  }
  const context2 = __classPrivateFieldGet23(this, _Page_frameManager, "f").executionContextById(event.executionContextId, __classPrivateFieldGet23(this, _Page_client, "f"));
...
}, "_Page_onConsoleAPI"), _Page_onBindingCalled = /* @__PURE__ */ __name(async function _Page_onBindingCalled2(event) {
  let payload;
  try {
    payload = JSON.parse(event.payload);
  } catch {
  ...
  try {
    ...
    if (isErrorLike(error3)) {
      expression = pageBindingDeliverErrorString(name, seq, error3.message, error3.stack);
    } else {
      expression = pageBindingDeliverErrorValueString(name, seq, error3);
    }
  }
...
}, "_Page_onBindingCalled"), _Page_addConsoleMessage = /* @__PURE__ */ __name(function _Page_addConsoleMessage2(eventType, args, stackTrace) {
...
}, "_Page_addConsoleMessage"), _Page_onDialog = /* @__PURE__ */ __name(function _Page_onDialog2(event) {
  let dialogType = null;
  ...
  assert3(dialogType, "Unknown javascript dialog type: " + event.type);
  const dialog = new Dialog(__classPrivateFieldGet23(this, _Page_client, "f"), dialogType, event.message, event.defaultPrompt);
  this.emit("dialog", dialog);
}, "_Page_onDialog"), _Page_resetDefaultBackgroundColor = /**
 * Resets default white background
 */
/* @__PURE__ */ __name(async function _Page_resetDefaultBackgroundColor2() {
  await __classPrivateFieldGet23(this, _Page_client, "f").send("Emulation.setDefaultBackgroundColorOverride");
}, "_Page_resetDefaultBackgroundColor"), _Page_setTransparentBackgroundColor = /**
 * Hides default white background
 */
/* @__PURE__ */ __name(async function _Page_setTransparentBackgroundColor2() {
  await __classPrivateFieldGet23(this, _Page_client, "f").send("Emulation.setDefaultBackgroundColorOverride", {
    color: { r: 0, g: 0, b: 0, a: 0 }
  });
}, "_Page_setTransparentBackgroundColor"), _Page_sessionClosePromise = /* @__PURE__ */ __name(function _Page_sessionClosePromise2() {
...
}, "_Page_sessionClosePromise"), _Page_go = /* @__PURE__ */ __name(async function _Page_go2(delta, options) {
  ...
  return result[0];
}, "_Page_go"), _Page_screenshotTask = /* @__PURE__ */ __name(async function _Page_screenshotTask2(format, options = {}) {
    ...
    _ChromeTargetManager_onAttachedToTarget.set(this, async (parentSession, event) => {
      ...
      for (const interceptor of __classPrivateFieldGet26(this, _ChromeTargetManager_targetInterceptors, "f").get(parentSession) || []) {
        if (!(parentSession instanceof Connection)) {
          assert3(__classPrivateFieldGet26(this, _ChromeTargetManager_attachedTargetsBySessionId, "f").has(parentSession.id()));
        }
...
_ChromeTargetManager_connection = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_discoveredTargetsByTargetId = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_attachedTargetsByTargetId = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_attachedTargetsBySessionId = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_ignoredTargets = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_targetFilterCallback = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_targetFactory = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_targetInterceptors = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_attachedToTargetListenersBySession = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_detachedFromTargetListenersBySession = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_initializeCallback = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_initializePromise = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_targetsIdsForInit = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_storeExistingTargetsForInit = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_onSessionDetached = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_onTargetCreated = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_onTargetDestroyed = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_onTargetInfoChanged = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_onAttachedToTarget = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_onDetachedFromTarget = /* @__PURE__ */ new WeakMap(), _ChromeTargetManager_instances = /* @__PURE__ */ new WeakSet(), _ChromeTargetManager_setupAttachmentListeners = /* @__PURE__ */ __name(function _ChromeTargetManager_setupAttachmentListeners2(session) {
  ...
  assert3(!__classPrivateFieldGet26(this, _ChromeTargetManager_attachedToTargetListenersBySession, "f").has(session));
  ...
  assert3(!__classPrivateFieldGet26(this, _ChromeTargetManager_detachedFromTargetListenersBySession, "f").has(session));
...
}, "_ChromeTargetManager_setupAttachmentListeners"), _ChromeTargetManager_removeAttachmentListeners = /* @__PURE__ */ __name(function _ChromeTargetManager_removeAttachmentListeners2(session) {
...
}, "_ChromeTargetManager_removeAttachmentListeners"), _ChromeTargetManager_finishInitializationIfReady = /* @__PURE__ */ __name(function _ChromeTargetManager_finishInitializationIfReady2(targetId) {
...
}, "_ChromeTargetManager_finishInitializationIfReady");
...
var FirefoxTargetManager = class extends EventEmitter2 {
  ...
  constructor(connection, targetFactory, targetFilterCallback) {
    ...
    _FirefoxTargetManager_onAttachedToTarget.set(this, async (parentSession, event) => {
      ...
      for (const hook of __classPrivateFieldGet27(this, _FirefoxTargetManager_targetInterceptors, "f").get(parentSession) || []) {
        if (!(parentSession instanceof Connection)) {
          assert3(__classPrivateFieldGet27(this, _FirefoxTargetManager_availableTargetsBySessionId, "f").has(parentSession.id()));
        }
  ...
  setupAttachmentListeners(session) {
    ...
    assert3(!__classPrivateFieldGet27(this, _FirefoxTargetManager_attachedToTargetListenersBySession, "f").has(session));
...
var Browser = class _Browser extends EventEmitter2 {
  static {
    __name(this, "Browser");
  }
  /**
  ...
  constructor(product, connection, contextIds, ignoreHTTPSErrors, defaultViewport, process2, closeCallback, targetFilterCallback, isPageTargetCallback, sessionId) {
    ...
    _Browser_createTarget.set(this, (targetInfo, session) => {
      ...
      const context2 = browserContextId && __classPrivateFieldGet28(this, _Browser_contexts, "f").has(browserContextId) ? __classPrivateFieldGet28(this, _Browser_contexts, "f").get(browserContextId) : __classPrivateFieldGet28(this, _Browser_defaultContext, "f");
      if (!context2) {
        throw new Error("Missing browser context");
      }
      return new Target(targetInfo, session, context2, __classPrivateFieldGet28(this, _Browser_targetManager, "f"), (isAutoAttachEmulated) => {
  ...
  static async _create(product, connection, contextIds, ignoreHTTPSErrors, defaultViewport, process2, closeCallback, targetFilterCallback, isPageTargetCallback, sessionId) {
    const browser = new _Browser(product, connection, contextIds, ignoreHTTPSErrors, defaultViewport, process2, closeCallback, targetFilterCallback, isPageTargetCallback, sessionId);
  ...
  async createIncognitoBrowserContext(options = {}) {
    ...
    const context2 = new BrowserContext(__classPrivateFieldGet28(this, _Browser_connection, "f"), this, browserContextId);
    __classPrivateFieldGet28(this, _Browser_contexts, "f").set(browserContextId, context2);
    return context2;
  }
  /**
   ...
   */
  async version() {
    const version2 = await __classPrivateFieldGet28(this, _Browser_instances, "m", _Browser_getVersion).call(this);
...
}, "_Browser_setIsPageTargetCallback"), _Browser_getVersion = /* @__PURE__ */ __name(function _Browser_getVersion2() {
...
var BrowserContext = class extends EventEmitter2 {
   ...
   */
  async close() {
    assert3(__classPrivateFieldGet28(this, _BrowserContext_id, "f"), "Non-incognito profiles cannot be closed!");
...
// src/crawler/utils/browser.ts
async function launchBrowser(browserBinding) {
  return await puppeteer_core_default.launch(browserBinding);
}
...
async function setupPage(browser, options = {}) {
  ...
  page.on("request", (request) => {
    ...
    if (options.blockImages && resourceType === "image" || options.blockFonts && resourceType === "font" || options.blockCSS && resourceType === "stylesheet") {
      request.abort();
    } else {
      request.continue();
    }
...
async function closePage(page) {
  ...
  try {
    ...
    console.error("Error closing page:", error3);
  }
}
__name(closePage, "closePage");
async function extractPageMetadata(page) {
  try {
    ...
    console.error("Error extracting metadata:", error3);
    let title2 = "";
    try {
      title2 = typeof page.title === "function" ? await page.title() : page.title;
    } catch (e) {
...
__name(extractPageMetadata, "extractPageMetadata");

// src/crawler/extractors/html.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
async function extractHtml(page, options = {}) {
...
// src/crawler/extractors/text.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
async function extractText(page, options = {}) {
  try {
    return await page.evaluate(() => {
      const bodyText = document.body.innerText || "";
      const images = Array.from(document.querySelectorAll("img[alt]"));
      const imageAltText = images.map((img) => `[Image: ${img.alt}]`).join(" ");
      return (bodyText + " " + imageAltText).trim();
    });
  } catch (error3) {
    console.error("Error extracting text:", error3);
    return "";
  }
}
__name(extractText, "extractText");

// src/crawler/extractors/selector.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
async function extractBySelector(page, selectors, options = {}) {
  const selectorList = Array.isArray(selectors) ? selectors : [selectors];
  return await page.evaluate((selectors2) => {
    return selectors2.map((selector) => {
      try {
...
__name(extractBySelector, "extractBySelector");

// src/crawler/extractors/js.ts
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
async function extractAfterJsExecution(page, options = {}) {
  try {
    const opts = {
      waitTime: options.waitTime ?? 1e3,
      ...
      selectorTimeout: options.selectorTimeout ?? 5e3,
    ...
    if (opts.waitForNetworkIdle) {
      try {
        ...
        console.warn("Network did not become idle within timeout:", error3);
      }
    }
    if (opts.waitForSelector) {
      try {
        ...
        console.warn(`Selector "${opts.waitForSelector}" did not appear within timeout:`, error3);
      }
    }
    if (opts.customScript) {
      await page.evaluate((script) => {
        try {
          ...
          console.error("Error executing custom script:", error3);
        }
      }, opts.customScript);
    }
    if (opts.waitTime > 0) {
    ...
    return {
      error: error3 instanceof Error ? error3.message : "Unknown error during JavaScript execution"
    };
  }
}
__name(extractAfterJsExecution, "extractAfterJsExecution");
async function extractElementsAfterJsExecution(page, selectors, options = {}) {
  try {
    ...
    return {
      error: error3 instanceof Error ? error3.message : "Unknown error during element extraction"
    };
  }
}
__name(extractElementsAfterJsExecution, "extractElementsAfterJsExecution");
...
var Crawler = class {
   ...
   */
  constructor(browserBinding, options = {}) {
   ...
   */
  createResponse(url, status, data = {}) {
    return {
      url,
      status,
      timestamp: Date.now(),
  ...
  async crawl(url) {
    ...
    try {
      ...
      return this.handleError(url, error3);
    } finally {
   ...
   */
  async extractBySelector(url, selectors, options = {}) {
    let browser = null;
    let page = null;
    try {
      browser = await launchBrowser(this.browserBinding);
   ...
   */
  async extractAfterJsExecution(url, options = {}) {
    let browser = null;
    let page = null;
    try {
      browser = await launchBrowser(this.browserBinding);
   ...
   */
  async extractElementsAfterJsExecution(url, selectors, options = {}) {
    let browser = null;
    let page = null;
    try {
      browser = await launchBrowser(this.browserBinding);
   ...
   */
  async executeCustomFunction(url, scriptFn, ...args) {
    let browser = null;
    let page = null;
    try {
      browser = await launchBrowser(this.browserBinding);
...
function handleApiError(error3) {
  console.error("API Error:", error3);
  if (error3 instanceof ValidationError) {
    return new Response(
      JSON.stringify({ error: error3.message }),
      { status: error3.status, headers: { "Content-Type": "application/json" } }
    );
  }
  const message = error3 && typeof error3 === "object" && "message" in error3 ? error3.message : String(error3);
  return new Response(
...
function parseCrawlerOptions(url) {
...
__name(parseCrawlerOptions, "parseCrawlerOptions");
function parseExtractionOptions(url) {
...
__name(parseExtractionOptions, "parseExtractionOptions");
function parseTextExtractionOptions(url) {
  const options = parseExtractionOptions(url);
...
__name(parseTextExtractionOptions, "parseTextExtractionOptions");
function parseSelectorExtractionOptions(url) {
  const options = parseExtractionOptions(url);
...
__name(parseSelectorExtractionOptions, "parseSelectorExtractionOptions");
function parseJsExtractionOptions(url) {
  const options = parseExtractionOptions(url);
...
__name(parseJsExtractionOptions, "parseJsExtractionOptions");
function parseSelectors(url, required = false) {
...
__name(parseSelectors, "parseSelectors");
...
// src/crawler/api/handlers.ts
async function handleHtmlExtraction(request, env2) {
  try {
    ...
    const crawler = new Crawler(env2.BROWSER, crawlerOptions);
    const result = await crawler.extractHtml(targetUrl, extractionOptions);
    return new Response(JSON.stringify(result), {
      headers: { "Content-Type": "application/json" }
    });
  } catch (error3) {
    return handleApiError(error3);
  }
}
__name(handleHtmlExtraction, "handleHtmlExtraction");
async function handleTextExtraction(request, env2) {
  try {
    const url = new URL(request.url);
    const targetUrl = validateUrl(url.searchParams.get("url"));
    const crawlerOptions = parseCrawlerOptions(url);
...
__name(handleTextExtraction, "handleTextExtraction");
async function handleSelectorExtraction(request, env2) {
  try {
    const url = new URL(request.url);
    const targetUrl = validateUrl(url.searchParams.get("url"));
...
__name(handleSelectorExtraction, "handleSelectorExtraction");
async function handleJsExtraction(request, env2) {
  try {
    const url = new URL(request.url);
    const targetUrl = validateUrl(url.searchParams.get("url"));
    ...
    const crawler = new Crawler(env2.BROWSER, crawlerOptions);
    const extractionResult = selectors ? await crawler.extractElementsAfterJsExecution(targetUrl, selectors, extractionOptions) : await crawler.extractAfterJsExecution(targetUrl, extractionOptions);
    let responseData = {
      url: targetUrl,
      status: 200,
      timestamp: Date.now()
    ...
    if (selectors) {
      ...
      if (outputType === "text") {
        responseData.text = Array.isArray(extractionResult) ? extractionResult.map((el) => el.results.map((r) => r.text).join(" ")).join("\n\n") : extractionResult && typeof extractionResult.text !== "undefined" ? extractionResult.text : "";
      }
      if (outputType === "html") {
...
__name(handleJsExtraction, "handleJsExtraction");
async function handleCustomJsExecution(request, env2) {
  try {
    if (request.method !== "POST") {
...
__name(handleCustomJsExecution, "handleCustomJsExecution");
async function handleSitemapRequest(request, env2) {
  try {
    const url = new URL(request.url);
    const sitemapUrl = validateUrl(url.searchParams.get("url"));
    let response;
    try {
    ...
    const xmlParserOptions = {
      ignoreAttributes: true,
      // We only need the <loc> tag value
      parseTagValue: true,
      trimValues: true,
      isArray: /* @__PURE__ */ __name((name, jpath) => jpath === "urlset.url", "isArray")
      // Ensure urlset.url is always an array
    };
    ...
    const urls = jsonObj?.urlset?.url?.map((entry) => entry?.loc).filter((loc) => typeof loc === "string") || [];
...
__name(handleSitemapRequest, "handleSitemapRequest");

// src/crawler/api/router.ts
function getAllowedMethodsForPath(pathname) {
  switch (pathname) {
    case "/crawler/html":
    case "/crawler/text":
    ...
    case "/crawler":
      return "GET, POST";
    // Legacy: type param determines allowed methods
    default:
      return "GET, POST";
  }
}
__name(getAllowedMethodsForPath, "getAllowedMethodsForPath");
async function handleApiRequest(request, env2) {
  ...
  try {
    switch (url.pathname) {
      case "/crawler/html":
        if (method === "GET") {
          return await handleHtmlExtraction(request, env2);
        }
        break;
      // Important: break after handling
      case "/crawler/text":
        if (method === "GET") {
          return await handleTextExtraction(request, env2);
        }
        break;
      case "/crawler/selector":
        if (method === "GET") {
          return await handleSelectorExtraction(request, env2);
        }
        break;
      // <-- ADDED Sitemap route -->
      case "/crawler/sitemap":
        if (method === "GET") {
          return await handleSitemapRequest(request, env2);
        }
        break;
      // <-- End ADDED Sitemap route -->
      case "/crawler/js":
        if (method === "GET" || method === "POST") {
          return await handleJsExtraction(request, env2);
        }
        break;
      case "/crawler/execute":
        if (method === "POST") {
          return await handleCustomJsExecution(request, env2);
        }
        break;
      ...
      case "/crawler":
        ...
        switch (type) {
          case "html":
            if (method === "GET") return await handleHtmlExtraction(request, env2);
            break;
          case "text":
            if (method === "GET") return await handleTextExtraction(request, env2);
            break;
          case "selector":
            if (method === "GET") return await handleSelectorExtraction(request, env2);
            break;
          // <-- ADDED Sitemap to legacy route -->
          case "sitemap":
            if (method === "GET") return await handleSitemapRequest(request, env2);
            break;
          // <-- End ADDED Sitemap to legacy route -->
          case "js":
            if (method === "GET" || method === "POST") return await handleJsExtraction(request, env2);
            break;
          case "execute":
            if (method === "POST") return await handleCustomJsExecution(request, env2);
            break;
          // Break here, otherwise it falls through to default
          default:
...
var middleware_insertion_facade_default = crawler_default;
